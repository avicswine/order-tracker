...
| 6 Etiquetas QR | ✅ | Impressão pelo navegador. Papéis: A4 ou **Zebra 10×15 cm** (4 etiquetas de 90×30 mm por página). Abas: **Pendentes do dia**, **Por NF** e **Catálogo completo**. Da triagem dá para imprimir **em lote**: seleciona as NFs → "🏷 Imprimir etiquetas" → SKUs de todas as NFs agrupados, sem os já impressos (`POST /catalogo/nfs`, máx. 60 NFs). Registro do que já foi impresso em `separacao_etiquetas` |
